...
use crate::utils::recalc_af::AlleleCount;
...
mod test {
    ...
    fn test_add_af() -> Result<(), VCFUtilsError> {
        ...
        let category_mapping = load_category_mapping::<_, RandomState>(
            &mut csv::Reader::from_reader(&include_bytes!("../../testfiles/1kGP-category.csv")[..]),
    ...
    fn test_load_category_mapping() {
        let data = include_bytes!("../../testfiles/category.csv");
