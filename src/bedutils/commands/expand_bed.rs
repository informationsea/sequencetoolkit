...
pub struct ExpandBed;

impl Command for ExpandBed {
    fn command_name(&self) -> &'static str {
        "expand"
    }

    fn config_subcommand(&self, app: App<'static, 'static>) -> App<'static, 'static> {
        app.about("Expand BED regions")
            .arg(
                Arg::with_name("input")
                    .index(1)
                    .takes_value(true)
    ...
    fn run(&self, matches: &ArgMatches<'static>) -> Result<(), crate::SequenceToolkitError> {
        let expand_start: u64 = matches
            ...
            .unwrap()
            .parse::<u64>()
            .context(crate::SequenceToolkitErrorKind::OtherError(
...
mod test {
    ...
    fn test_expand() -> Result<(), crate::SequenceToolkitError> {
        ...
        let matches = command.get_matches_from(&[
            ...
            "--expand",
            "10",
            "testfiles/bedutils/sample1.bed",
        ]);
        app.run(&matches)?;
