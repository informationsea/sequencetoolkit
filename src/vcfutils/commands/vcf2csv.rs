...
use crate::vcfutils::logic::vcf2table::{
    create_header_line, vcf2table, vcf2table_set_data_type, VCF2CSVConfig,
};
use crate::vcfutils::utils;
use crate::vcfutils::utils::tablewriter::{CSVWriter, TSVWriter, TableWriter, XlsxSheetWriter};
        ...
        let matches = VCF2CSV
            ...
            .get_matches_from_safe(
                [
                    ...
                    "xlsx",
                    "-c",
                    "testfiles/vcfutils/canonical.txt",
                ]
                .iter(),
            )
            .unwrap();
